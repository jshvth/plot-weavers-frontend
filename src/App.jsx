...
function App() {
  return (
    /* text-gray-900 (Hell) und dark:text-gray-100 (Dunkel) */
    <div className="flex flex-col min-h-screen bg-transparent text-gray-900 dark:text-gray-100 transition-colors duration-300">
      <Navbar />
